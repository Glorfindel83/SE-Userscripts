...
(function () {
  ...
  var undeletedQuestions = questionsPanel.find('div.p12').not('.bg-red-100').length;
  var deletedQuestions = questionsPanel.find('div.p12.bg-red-100').length;
  if (undeletedQuestions > 0) // User has content - use the dialog instead
    return;
  var answersPanel = $('#user-panel-answers');
  var undeletedAnswers = answersPanel.find('div.p12').not('.bg-red-100').length;
  var deletedAnswers = answersPanel.find('div.p12.bg-red-100').length;
